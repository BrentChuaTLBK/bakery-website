  ...
  if (action === "subscribe") {
    ...
    if (state.send) {
      ...
      await api("/emails", "POST", {
        ...
        html: `<html><body style="margin:0;padding:32px;background:#fff9f2;color:#402b1e;font-family:Arial,sans-serif"><main style="max-width:520px;margin:auto"><h1>Fresh from the TLB kitchen</h1><p>Confirm your email to hear about new treats, seasonal menus, and special offers.</p><p><a href="${link}" style="display:inline-block;background:#714029;color:white;padding:14px 22px;border-radius:8px">Confirm my subscription</a></p><p>This link expires in 24 hours. If you did not request this, ignore this email. You will not be subscribed.</p><p>You can unsubscribe from any newsletter.</p><p>The Little Baker Kitchen</p></main></body></html>`,
